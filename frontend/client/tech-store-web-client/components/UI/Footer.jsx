"use client";
import { faFacebook, faFacebookSquare, faGithub, faYoutube } from "@fortawesome/free-brands-svg-icons";
    ...
    <div className="h-fit w-full bg-secondary text-on-secondary flex sm:flex-row gap-4 flex-col px-10 md:px-20 py-10">
      <div className="flex sm:flex-row flex-col gap-10 grow">
        ...
        <div className='flex flex-col gap-2'>
          ...
          <ul className='flex sm:flex-col gap-1 text-sm text-on-secondary/50'>
            <li className="hover:text-on-secondary cursor-pointer">Contact us</li>
            <li className="hover:text-on-secondary cursor-pointer">Order tracking</li>
          </ul>
        </div>
        <div className='flex flex-col gap-2'>
          <span className='font-bold'>Our company</span>
          <ul className='flex sm:flex-col gap-1 text-sm text-on-secondary/50'>
            <li className="hover:text-on-secondary cursor-pointer">About us</li>
